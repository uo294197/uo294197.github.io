class Pais {
    ...
    setValores() {
        ...
        this.idioma = "&lang=es"; 
        this.url = "http://api.openweathermap.org/data/2.5/forecast?q=" + "Shanghai" + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey;
    }
  ...
  cargarDatos(horaEspecifica) {
    $.ajax({
      ...
      success: function(datos){
                    ...
                    var stringDatos =  "<ul><li>NÃºmero de elementos del XML: " + totalNodos + "</li>";
                        ...
                        stringDatos += "<li>DirecciÃ³n del viento: " + direccionViento + " grados</li>";
                        ...
                        stringDatos += "<li>PrecipitaciÃ³n modo: " + precipitacionMode + "</li>";
